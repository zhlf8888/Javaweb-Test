...
<html>
  ...
  <body>
    ...
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li role="presentation class="active"><a href="main_insert.jsp" data-toggle="tab">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp新&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp建&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a></li>
...
<center>
    <form class="form" action = "db_insert" method = "post">
